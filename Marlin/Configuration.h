...
#define STRING_CONFIG_H_AUTHOR "Danol" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "E3V2"
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -38, -2.5, 0 }
...
#define XY_PROBE_FEEDRATE (167*60)
...
//#define NOZZLE_CLEAN_FEATURE
  ...
  #define NOZZLE_CLEAN_START_POINT { {  20, 20, (Z_MIN_POS + 1) } }
  #define NOZZLE_CLEAN_END_POINT   { { 100, 20, (Z_MIN_POS + 1) } }
